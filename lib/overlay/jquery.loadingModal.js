(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var $eText = $('<div class="jquery-loading-modal__eText"></div>');
            var $eTextF = false;
            ...
            if (Array.isArray(this.settings.eText)) {
                $eTextF = true;
                $eText.html(this.settings.eText[0])
            }
            ...
            $infoBox.append($animationBox).append($text).append($eText);
            ...
            this.eText = $eText;
            this.ceTCount = 0;
            this.eTTimer = this.settings.eTTimer;
        },
        hide: function () {
            var modal = this.modal;
            modal.removeClass('jquery-loading-modal--visible').addClass('jquery-loading-modal--hidden');
            if(this.eTextF){
                if(this.modalETTimer != null) clearTimeout(this.modalETTimer);
                this.ceTCount = 0;
                this.eText.html(this.settings.eText[0]);
            }
            setTimeout(function(){
                modal.hide();
            }, 1000);
        ...
        show: function () {
            if(this.eTextF){
                ...
                this.eText.html(this.settings.eText[0]);
                if(this.modalETTimer != null) clearTimeout(this.modalETTimer);
                this.modalETimer = setTimeout(function(e){ e.updateET(); }, this.eTTimer, this);
            }
        ...
        updateET: function () {
            if(this.eTextF){
                if (++this.ceTCount >= this.settings.eText.length) return;
                this.eText.hide().html(this.settings.eText[this.ceTCount]).fadeIn(1500);
                if(this.modalETTimer != null) clearTimeout(this.modalETTimer);
                this.modalETimer = setTimeout(function(e){ e.updateET(); }, this.eTTimer, this);
            }
        }
